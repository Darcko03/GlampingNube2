...
use App\Http\Requests\StorePayment_Method;
...
class PaymentMethodController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StorePayment_Method $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StorePayment_Method $request, PaymentMethod $paymentMethod)
    {
        request()->validate(PaymentMethod::$rules);
