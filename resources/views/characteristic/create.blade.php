            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Crear') }} Caracteristica</span>
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('characteristics.index') }}"> {{ __('Volver') }}</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('characteristics.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
